...
class ProductTemplate(models.Model):
    ...
    dint_2_tolerancia_maior = fields.Many2one('reobote.custom', string="+ (DI2)", domain=[('campo', '=', 'dint2_tolerancia_maior')])
    dint_2_tolerancia_menor = fields.Many2one('reobote.custom', string="- (DI2)", domain=[('campo', '=', 'dint2_tolerancia_menor')])
    ...
    dext_2_tolerancia_maior = fields.Many2one('reobote.custom', string="+ (DE2)", domain=[('campo', '=', 'dext2_tolerancia_maior')])
    dext_2_tolerancia_menor = fields.Many2one('reobote.custom', string="- (DE2)", domain=[('campo', '=', 'dext2_tolerancia_menor')])
